 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://server.jaxws.tests.jch.pl/", wsdlLocation = "http://localhost:8888/ws/person?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://server.jaxws.tests.jch.pl/", "PersonServiceImplService");
    ...
    public PersonService getPersonServiceImplPort() {
        return super.getPort(new QName("http://server.jaxws.tests.jch.pl/", "PersonServiceImplPort"), PersonService.class);
    }
    ...
    public PersonService getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.jaxws.tests.jch.pl/", "PersonServiceImplPort"), PersonService.class, features);
    }
